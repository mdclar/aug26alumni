...
import {
  ...
  BookText, Image as ImageIcon, ListOrdered, ExternalLink, Compass, Map as MapIcon, MessageCircle, Send, Music,
} from "lucide-react";
...
const ITIN_DOC=`August 2026 Itinerary
August 2 – August 13, 2026
This Itinerary Is Dynamic and Will be Updated As Plans Change

SATURDAY, August 1 (Optional)
10:30 am Church Services (You can leave your bags if you come for church but you cannot stay at the Center after church)
5:00 pm – Check into Jerusalem Center (if you opt to pay extra for one additional night)
Please have final cash payment and any money owed for extra night stay, cabs, etc… ready to present when you arrive at the JC to check in. You will give that money to me.

~ Free time will be added some afternoons

SUNDAY, August 2
Group 1 devotional – 10 minutes total
7:00 – 7:45 Breakfast
8:00 Security / Orientation
9:00 Shuttle Pickup at Upper Gate
Seven Arches Overlook
Orientation Walk – This will be a fairly long walk in and out of shade through the Old City
City of David
Hezekiah’s Tunnel
Pools of Siloam (You could find a taxi after this if you can’t walk back up hill)
Pilgrim’s Tunnel
Free Time – (You will be on your own to shop, go back to the JC, or wander…)
— Plan on lots of walking this day. Prepare to get wet in Hezekiah’s Tunnel.
Wear skirts or pants (best if they can roll up) & shoes that can get wet
No shorts other than if you want to change into them just for the tunnel
There are changing area/bathrooms at the start of Hezekiah’s and a couple bathrooms at the end.
Bring headlamps or flashlights, water, TP, shekels, hats, receivers (insert your batteries into the receivers) and bring headphones
(Swimsuits and towels are not necessary)

6:30 PM Dinner in the Oasis
7:30 – 7:50 Watch the Sunset Over Jerusalem (Go out Level 7 doors by Admin offices)
(We will need to watch from the 7th floor terrace but stay out of the view from the upper auditorium after sunset so concert goers do not see us roaming around in their view of Jerusalem)
Evening Activity:
8:00 Public Concert, Upper Auditorium (totally optional)
Summer Nights, The Gary Bertini Israeli Choir
...
Group 2 devotional
7:00 Breakfast
7:50 Put luggage by this time
Leave for Galilee Region
Caesaria Maritima
Nazareth Village
Church of the Annunciation
St. Joseph’s Church
Check In at Ein Gev
Pack clothing for 3 nights and 3 days, including swimsuits.
Do not wear shorts
Comfortable Walking Shoes & Hats
Bring PASSPORTS on the bus, water bottle, hat, receiver, walking shoes, luggage with 3 days and nights clothing– pack swimsuits
...
Evening Activity: Highlights & testimonies on the lawn (optional)
Bring water bottle, hat, receiver, field trip manual
No shorts because we go to churches
Shorts can be worn at the resort

WEDNESDAY, August 5
Group 4 devotional
Northern Galilee Sites, such as
Tel Dan
Caesaria Philippi (Banias)
Har Bental
You can wear knee length shorts this day
Bring water bottle, hat, receiver, field trip manual
...
Beit She’an
Gan HaShlosha
Arrive back at Jerusalem Center
Bring: Bring water bottle, hat, receiver, field trip manual, swimsuit, & PASSPORT on the bus with you
There are changing areas at Gan HaShlosha & we provide towels
...
Church of Nativity
Milk Grotto
Lunch at Tent Restaurant
Shepherd’s Field
Dinner at JC
Bring water bottle, hat, receiver, field trip manual, & PASSPORT
No shorts
6:00 Dinner to get to Western Wall on time

Evening Activity – Usher in Shabbat at the Western Wall
7:15 shuttle pickup, upper gate
...
Bring: Water bottle, TP & receiver
Wear Church clothing until after dinner, suit coats are not necessary
There is no lunch on the sabbath at the JC

Evening Activity: Organ Demonstration by Sister Debra Bendheim

SUNDAY, August 9
Group 2 devotional
HOT day in the Judean Desert
Masada
Dead Sea Float
Qasr al Yahud Baptismal Site
Jericho
Bring: Water bottle, hat, receiver, field trip manual, swimsuit & PASSPORT

Evening Activity: Public Concert, Upper Auditorium (optional)
Nari Baroque Ensemble, Liron Givoni, soprano
Naomi Hassoun, recorder
Yotam Haran, cello
Guy Pardo, harpsicord

MONDAY, August 10
Group 3 devotional
Haram al-Sharif
Davidson Archeology
Notre Dame Pentecost Room
Free Time – Mahene Yehuda to Jaffa Gate
YMCA Carillon Bell Tower Demo by Sister Bendheim (optional)
For Haram Al-Sherif, both “men and women must dress modestly. Knees and shoulders must be covered, and loose-fitting clothing is recommended.” Women should have elbows covered and pants or skirts should go to your ankles. You cannot bring any non-Islamic religious items like scriptures. And DO NOT touch anyone of the opposite gender. So not pose for photos holding hands or with your arm around your spouse.
6:30 Dinner
Evening Activity: Speaker, April – History of the Jerusalem Center
...
Bell Caves
Lachish (If timing permits)
Water bottle, hat, receiver, field trip manual, sack lunch & TP
Passport not needed & field trip manual is optional
Evening Activity: Service Project, Assembling school kits for Israel and West Bank students

WEDNESDAY, August 12
Group 5 devotional
Palm Sunday Route, Mount of Olives
8:00 Shuttle, then you will walk down hill between sites all morning
Bethpage
Dominus Flevit
Gethsemane
Church of All Nations
Gethsemane Private Garden
Free Time – You will be set free from here to walk or take taxi to Old City or back to JC
Water bottle, hat, receiver, sack lunch & TP
Passport not needed & field trip manual is optional
Evening Activity: 8 pm Highlights and Testimonies, Student Commons, Level 6

THURSDAY, August 13
Free Day
Check Out of Center Before 5:00 PM
Only Breakfast Served

Checkout Instructions:
Bring your receiver to dinner with you the night before you leave
Place your dirty sheets and towels in a pile on the floor of your room
Place your key in the key drop by the Oasis
Write your name on the list that you turned in your key
DO NOT LEAVE WITHOUT GIVING US YOUR RECEIVER AND KEYS`;
const CHOSEN = {"s6": [{"t": "S1 E5 — “The Wedding Gift”", "href": "https://www.byutv.org/the-chosen/episodes/season-1", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%201%20episode%205%20wedding%20at%20Cana", "spl": "Find on YouTube ↗", "why": "The wedding at Cana of Galilee — the first miracle fills the back half of the episode."}], "s8": [{"t": "Christmas Special — “The Messengers”", "href": "https://www.byutv.org/the-chosen", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20The%20Messengers%20Christmas%20special", "spl": "Find on YouTube ↗", "why": "Mary and Joseph remember Nazareth and the annunciation on the night of the Nativity."}], "s9": [{"t": "Christmas Special — “The Messengers”", "href": "https://www.byutv.org/the-chosen", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20The%20Messengers%20Christmas%20special", "spl": "Find on YouTube ↗", "why": "Joseph of Nazareth's side of the story, told on the night of the Nativity."}], "s13": [{"t": "S2 E8 → S3 E1 — the Sermon on the Mount", "href": "https://www.byutv.org/the-chosen/episodes/season-2", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20sermon%20on%20the%20mount%20season%202%20finale", "spl": "Find on YouTube ↗", "why": "Season 2 ends as Jesus climbs the mount and begins to preach; Season 3 opens in the middle of the sermon."}], "s14": [{"t": "S3 E8 — “Sustenance”", "href": "https://www.byutv.org/the-chosen/episodes/season-3", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%203%20episode%208%20feeding%205000", "spl": "Find on YouTube ↗", "why": "The feeding of the five thousand — the loaves and fishes fill the final act."}], "s16": [{"t": "S1 E6 — “Indescribable Compassion”", "href": "https://www.byutv.org/the-chosen/episodes/season-1", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%201%20episode%206%20paralytic%20roof", "spl": "Find on YouTube ↗", "why": "The paralytic lowered through the roof at Capernaum — the closing scene of the episode."}], "s17": [{"t": "S1 E1 — “I Have Called You by Name”", "href": "https://www.byutv.org/the-chosen/episodes/season-1", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%201%20episode%201%20Mary%20Magdalene%20redeemed", "spl": "Find on YouTube ↗", "why": "Mary of Magdala's deliverance — the redemption scene that closes the very first episode."}], "s18": [{"t": "S1 E4 — “The Rock on Which It Is Built”", "href": "https://www.byutv.org/the-chosen/episodes/season-1", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%201%20episode%204%20miraculous%20catch", "spl": "Find on YouTube ↗", "why": "The miraculous catch of fish and Peter's call, the last third of the episode — on this water."}, {"t": "S3 E8 — “Sustenance”", "href": "https://www.byutv.org/the-chosen/episodes/season-3", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%203%20finale%20walking%20on%20water", "spl": "Find on YouTube ↗", "why": "Jesus walks on this sea and Peter steps out of the boat — the final minutes of Season 3."}], "s19": [{"t": "S4 E2 — “Confessions”", "href": "https://www.byutv.org/the-chosen/episodes/season-4", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%204%20episode%202%20Peter%20confession", "spl": "Find on YouTube ↗", "why": "“Thou art the Christ” — Peter's confession at Caesarea Philippi closes the episode."}], "s23": [{"t": "S4 E7 — “The Last Sign”", "href": "https://www.byutv.org/the-chosen/episodes/season-4", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%204%20episode%207%20Lazarus", "spl": "Find on YouTube ↗", "why": "The raising of Lazarus at Bethany — the climax of the episode and of the season."}], "s24": [{"t": "Pilot short — “The Shepherd”", "href": "https://www.byutv.org/the-chosen", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20The%20Shepherd%20pilot%20nativity", "spl": "Find on YouTube ↗", "why": "The Nativity through a shepherd's eyes — the short film that started the whole series."}], "s25": [{"t": "Christmas Special — “The Messengers”", "href": "https://www.byutv.org/the-chosen", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20The%20Messengers%20Christmas%20special", "spl": "Find on YouTube ↗", "why": "The night of the Nativity in Bethlehem, remembered by Mary and Joseph."}], "s27": [{"t": "Pilot short — “The Shepherd”", "href": "https://www.byutv.org/the-chosen", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20The%20Shepherd%20pilot%20shepherds", "spl": "Find on YouTube ↗", "why": "Angels over these fields — the announcement to the shepherds is the heart of the short."}], "s29": [{"t": "Coming in Season 6", "href": "https://www.byutv.org/the-chosen", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%206%20trailer", "spl": "Find on YouTube ↗", "why": "The trial, crucifixion, and the empty tomb are the story of Season 6, released summer 2026 (The Chosen app / Prime Video first)."}], "s30": [{"t": "Coming in Season 6", "href": "https://www.byutv.org/the-chosen", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%206%20trailer", "spl": "Find on YouTube ↗", "why": "Peter's denial in the high priest's courtyard — the Gallicantu scene — arrives in Season 6 (summer 2026)."}], "s31": [{"t": "Season 5 — “The Last Supper”", "href": "https://www.byutv.org/the-chosen/episodes/season-5", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%205%20last%20supper", "spl": "Find on YouTube ↗", "why": "The Upper Room is the frame of all of Season 5 — Last Supper scenes are woven through every episode."}], "s33": [{"t": "Coming in Season 6", "href": "https://www.byutv.org/the-chosen", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%206%20trailer", "spl": "Find on YouTube ↗", "why": "The crucifixion and burial — the events beneath this church — are Season 6 (summer 2026)."}], "s38": [{"t": "S5 E1 — “Entry”", "href": "https://www.byutv.org/the-chosen/episodes/season-5", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%205%20episode%201%20temple%20cleansing", "spl": "Find on YouTube ↗", "why": "Jesus cleanses the temple courts — the second half of the episode happens on this mount."}, {"t": "S5 E3 — “Woes”", "href": "https://www.byutv.org/the-chosen/episodes/season-5", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%205%20episode%203%20woes", "spl": "Find on YouTube ↗", "why": "Teaching the Passover crowds in the temple courts."}], "s39": [{"t": "S5 E1 & E3 — in the temple courts", "href": "https://www.byutv.org/the-chosen/episodes/season-5", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%205%20temple%20courts", "spl": "Find on YouTube ↗", "why": "The southern steps and courts you're standing in are where these Passover-week scenes are set."}], "s42": [{"t": "S2 E4 — “The Perfect Opportunity”", "href": "https://www.byutv.org/the-chosen/episodes/season-2", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%202%20episode%204%20pool%20of%20Bethesda", "spl": "Find on YouTube ↗", "why": "The healing of the man who waited thirty-eight years at this pool — the climax of the episode."}], "s47": [{"t": "S5 E1 — “Entry”", "href": "https://www.byutv.org/the-chosen/episodes/season-5", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%205%20episode%201%20triumphal%20entry", "spl": "Find on YouTube ↗", "why": "The triumphal entry begins here at Bethphage — the donkey, the palms, the descent: the opening act."}], "s48": [{"t": "S5 E1 — “Entry”", "href": "https://www.byutv.org/the-chosen/episodes/season-5", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%205%20episode%201%20triumphal%20entry", "spl": "Find on YouTube ↗", "why": "The descent of the Mount of Olives into the city — the road of Dominus Flevit — opens the episode."}], "s49": [{"t": "Season 5 — closing episodes", "href": "https://www.byutv.org/the-chosen/episodes/season-5", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%205%20Gethsemane", "spl": "Find on YouTube ↗", "why": "The season moves from the Upper Room to Gethsemane; the garden and the arrest close the season."}], "s50": [{"t": "Season 5 — closing episodes", "href": "https://www.byutv.org/the-chosen/episodes/season-5", "sp": "https://www.youtube.com/results?search_query=The%20Chosen%20season%205%20Gethsemane", "spl": "Find on YouTube ↗", "why": "Gethsemane — the events remembered in this church end Season 5."}]};
const ARTMUSIC = {"s1": [{"href": "https://www.youtube.com/results?search_query=Yerushalayim%20Shel%20Zahav%20%28Jerusalem%20of%20Gold%29%20%E2%80%94%20Naomi%20Shemer", "t": "♪ Yerushalayim Shel Zahav (Jerusalem of Gold) — Naomi Shemer", "sp": "https://open.spotify.com/search/Yerushalayim%20Shel%20Zahav%20%28Jerusalem%20of%20Gold%29%20%E2%80%94%20Naomi%20Shemer"}, {"href": "https://www.youtube.com/results?search_query=The%20Holy%20City%20%E2%80%94%20Stephen%20Adams%20%28Jerusalem%21%20Jerusalem%21%29", "t": "♪ The Holy City — Stephen Adams (Jerusalem! Jerusalem!)", "sp": "https://open.spotify.com/search/The%20Holy%20City%20%E2%80%94%20Stephen%20Adams%20%28Jerusalem%21%20Jerusalem%21%29"}, {"href": "https://www.google.com/search?tbm=isch&q=David%20Roberts%2C%20Jerusalem%20from%20the%20Mount%20of%20Olives%20%281839%29", "t": "Art · David Roberts, Jerusalem from the Mount of Olives (1839)"}], "s2": [{"href": "https://www.youtube.com/results?search_query=David%20Melech%20Yisrael%20%E2%80%94%20traditional%20round", "t": "♪ David Melech Yisrael — traditional round", "sp": "https://open.spotify.com/search/David%20Melech%20Yisrael%20%E2%80%94%20traditional%20round"}, {"href": "https://www.youtube.com/results?search_query=I%20Was%20Glad%20%E2%80%94%20Parry%20%28Psalm%20122%29", "t": "♪ I Was Glad — Parry (Psalm 122)", "sp": "https://open.spotify.com/search/I%20Was%20Glad%20%E2%80%94%20Parry%20%28Psalm%20122%29"}, {"href": "https://www.google.com/search?tbm=isch&q=Rembrandt%2C%20David%20Playing%20the%20Harp%20before%20Saul", "t": "Art · Rembrandt, David Playing the Harp before Saul"}], "s3": [{"href": "https://www.youtube.com/results?search_query=I%20Was%20Glad%20%E2%80%94%20Parry%20%28Psalm%20122%29", "t": "♪ I Was Glad — Parry (Psalm 122)", "sp": "https://open.spotify.com/search/I%20Was%20Glad%20%E2%80%94%20Parry%20%28Psalm%20122%29"}, {"href": "https://www.google.com/search?tbm=isch&q=James%20Tissot%2C%20The%20Blind%20Man%20Washes%20in%20the%20Pool%20of%20Siloam", "t": "Art · James Tissot, The Blind Man Washes in the Pool of Siloam"}], "s4": [{"href": "https://www.youtube.com/results?search_query=The%20Holy%20City%20%E2%80%94%20Stephen%20Adams", "t": "♪ The Holy City — Stephen Adams", "sp": "https://open.spotify.com/search/The%20Holy%20City%20%E2%80%94%20Stephen%20Adams"}, {"href": "https://www.google.com/search?tbm=isch&q=James%20Tissot%2C%20The%20Blind%20Man%20Washes%20in%20the%20Pool%20of%20Siloam", "t": "Art · James Tissot, The Blind Man Washes in the Pool of Siloam"}], "s5": [{"href": "https://www.youtube.com/results?search_query=Yerushalayim%20Shel%20Zahav%20%28Jerusalem%20of%20Gold%29%20%E2%80%94%20Naomi%20Shemer", "t": "♪ Yerushalayim Shel Zahav (Jerusalem of Gold) — Naomi Shemer", "sp": "https://open.spotify.com/search/Yerushalayim%20Shel%20Zahav%20%28Jerusalem%20of%20Gold%29%20%E2%80%94%20Naomi%20Shemer"}], "s6": [{"href": "https://open.spotify.com/track/1im9JJPxkec4Jw2GD1dpDk", "t": "♪ El Yivneh Hagalil — BYU Men’s Chorus (Spotify)"}, {"href": "https://www.youtube.com/watch?v=a_04IGVpq7I", "t": "♪ El Yivneh Hagalil — BYU Men’s Chorus (YouTube)"}], "s7": [{"href": "https://www.youtube.com/results?search_query=The%20Angel%20Gabriel%20from%20Heaven%20Came%20%28Gabriel%27s%20Message%29%20%E2%80%94%20Basque%20carol", "t": "♪ The Angel Gabriel from Heaven Came (Gabriel's Message) — Basque carol", "sp": "https://open.spotify.com/search/The%20Angel%20Gabriel%20from%20Heaven%20Came%20%28Gabriel%27s%20Message%29%20%E2%80%94%20Basque%20carol"}, {"href": "https://www.google.com/search?tbm=isch&q=Henry%20Ossawa%20Tanner%2C%20The%20Annunciation%20%281898%29", "t": "Art · Henry Ossawa Tanner, The Annunciation (1898)"}], "s8": [{"href": "https://www.youtube.com/results?search_query=Bach%20Magnificat", "t": "♪ Bach Magnificat", "sp": "https://open.spotify.com/search/Bach%20Magnificat"}, {"href": "https://www.youtube.com/results?search_query=Schubert%20Ave%20Maria", "t": "♪ Schubert Ave Maria", "sp": "https://open.spotify.com/search/Schubert%20Ave%20Maria"}, {"href": "https://www.google.com/search?tbm=isch&q=Henry%20Ossawa%20Tanner%2C%20The%20Annunciation%20%281898%29", "t": "Art · Henry Ossawa Tanner, The Annunciation (1898)"}, {"href": "https://www.google.com/search?tbm=isch&q=Fra%20Angelico%2C%20The%20Annunciation%20%28San%20Marco%29", "t": "Art · Fra Angelico, The Annunciation (San Marco)"}], "s9": [{"href": "https://www.youtube.com/results?search_query=The%20Angel%20Gabriel%20from%20Heaven%20Came%20%28Gabriel%27s%20Message%29", "t": "♪ The Angel Gabriel from Heaven Came (Gabriel's Message)", "sp": "https://open.spotify.com/search/The%20Angel%20Gabriel%20from%20Heaven%20Came%20%28Gabriel%27s%20Message%29"}, {"href": "https://www.google.com/search?tbm=isch&q=Georges%20de%20La%20Tour%2C%20Saint%20Joseph%20the%20Carpenter", "t": "Art · Georges de La Tour, Saint Joseph the Carpenter"}], "s12": [{"href": "https://www.youtube.com/results?search_query=V%27ulai%20%E2%80%94%20Rachel%20/%20Kinneret%20song%20%28Esther%20Ofarim%29", "t": "♪ V'ulai — Rachel / Kinneret song (Esther Ofarim)", "sp": "https://open.spotify.com/search/V%27ulai%20%E2%80%94%20Rachel%20/%20Kinneret%20song%20%28Esther%20Ofarim%29"}, {"href": "https://www.google.com/search?tbm=isch&q=David%20Roberts%2C%20Sea%20of%20Galilee%20lithograph", "t": "Art · David Roberts, Sea of Galilee lithograph"}], "s13": [{"href": "https://www.youtube.com/results?search_query=Arvo%20Part%2C%20The%20Beatitudes", "t": "♪ Arvo Part, The Beatitudes", "sp": "https://open.spotify.com/search/Arvo%20Part%2C%20The%20Beatitudes"}, {"href": "https://www.youtube.com/results?search_query=Dear%20Lord%20and%20Father%20of%20Mankind%20%E2%80%94%20Repton", "t": "♪ Dear Lord and Father of Mankind — Repton", "sp": "https://open.spotify.com/search/Dear%20Lord%20and%20Father%20of%20Mankind%20%E2%80%94%20Repton"}, {"href": "https://www.google.com/search?tbm=isch&q=James%20Tissot%2C%20The%20Sermon%20of%20the%20Beatitudes", "t": "Art · James Tissot, The Sermon of the Beatitudes"}], "s14": [{"href": "https://www.youtube.com/results?search_query=Break%20Thou%20the%20Bread%20of%20Life%20%E2%80%94%20hymn", "t": "♪ Break Thou the Bread of Life — hymn", "sp": "https://open.spotify.com/search/Break%20Thou%20the%20Bread%20of%20Life%20%E2%80%94%20hymn"}, {"href": "https://www.google.com/search?tbm=isch&q=Tabgha%20loaves%20and%20fishes%20mosaic", "t": "Art · Tabgha loaves and fishes mosaic"}], "s15": [{"href": "https://www.youtube.com/results?search_query=Dear%20Lord%20and%20Father%20of%20Mankind%20%E2%80%94%20Repton", "t": "♪ Dear Lord and Father of Mankind — Repton", "sp": "https://open.spotify.com/search/Dear%20Lord%20and%20Father%20of%20Mankind%20%E2%80%94%20Repton"}, {"href": "https://www.google.com/search?tbm=isch&q=Raphael%2C%20Christ%27s%20Charge%20to%20Peter%20%281515%29", "t": "Art · Raphael, Christ's Charge to Peter (1515)"}], "s16": [{"href": "https://www.youtube.com/results?search_query=Master%2C%20the%20Tempest%20Is%20Raging%20%E2%80%94%20hymn", "t": "♪ Master, the Tempest Is Raging — hymn", "sp": "https://open.spotify.com/search/Master%2C%20the%20Tempest%20Is%20Raging%20%E2%80%94%20hymn"}, {"href": "https://www.google.com/search?tbm=isch&q=Bernhard%20Rode%2C%20Christ%20Healing%20the%20Paralytic%20at%20Capernaum", "t": "Art · Bernhard Rode, Christ Healing the Paralytic at Capernaum"}], "s17": [{"href": "https://www.youtube.com/results?search_query=In%20the%20Garden%20%E2%80%94%20C.%20Austin%20Miles", "t": "♪ In the Garden — C. Austin Miles", "sp": "https://open.spotify.com/search/In%20the%20Garden%20%E2%80%94%20C.%20Austin%20Miles"}, {"href": "https://www.google.com/search?tbm=isch&q=Georges%20de%20La%20Tour%2C%20Magdalene%20with%20the%20Smoking%20Flame", "t": "Art · Georges de La Tour, Magdalene with the Smoking Flame"}], "s18": [{"href": "https://open.spotify.com/track/1im9JJPxkec4Jw2GD1dpDk", "t": "♪ El Yivneh Hagalil — BYU Men’s Chorus (Spotify)"}, {"href": "https://www.youtube.com/watch?v=a_04IGVpq7I", "t": "♪ El Yivneh Hagalil — BYU Men’s Chorus (YouTube)"}, {"href": "https://www.youtube.com/results?search_query=Master%2C%20the%20Tempest%20Is%20Raging%20%E2%80%94%20hymn", "t": "♪ Master, the Tempest Is Raging — hymn", "sp": "https://open.spotify.com/search/Master%2C%20the%20Tempest%20Is%20Raging%20%E2%80%94%20hymn"}, {"href": "https://www.google.com/search?tbm=isch&q=Rembrandt%2C%20The%20Storm%20on%20the%20Sea%20of%20Galilee%20%281633%29", "t": "Art · Rembrandt, The Storm on the Sea of Galilee (1633)"}, {"href": "https://www.google.com/search?tbm=isch&q=Delacroix%2C%20Christ%20Asleep%20during%20the%20Tempest", "t": "Art · Delacroix, Christ Asleep during the Tempest"}], "s19": [{"href": "https://www.youtube.com/results?search_query=Sicut%20Cervus%20%E2%80%94%20Palestrina%20%28Psalm%2042%29", "t": "♪ Sicut Cervus — Palestrina (Psalm 42)", "sp": "https://open.spotify.com/search/Sicut%20Cervus%20%E2%80%94%20Palestrina%20%28Psalm%2042%29"}, {"href": "https://www.youtube.com/results?search_query=Hine%20Ma%20Tov%20%28Psalm%20133%29", "t": "♪ Hine Ma Tov (Psalm 133)", "sp": "https://open.spotify.com/search/Hine%20Ma%20Tov%20%28Psalm%20133%29"}, {"href": "https://www.google.com/search?tbm=isch&q=Perugino%2C%20Delivery%20of%20the%20Keys%20%28Sistine%20Chapel%29", "t": "Art · Perugino, Delivery of the Keys (Sistine Chapel)"}, {"href": "https://www.google.com/search?tbm=isch&q=Fragonard%2C%20Jeroboam%20Sacrificing%20to%20Idols", "t": "Art · Fragonard, Jeroboam Sacrificing to Idols"}], "s20": [{"href": "https://www.youtube.com/results?search_query=%27Tis%20Good%20Lord%20to%20Be%20Here%20%E2%80%94%20hymn", "t": "♪ 'Tis Good Lord to Be Here — hymn", "sp": "https://open.spotify.com/search/%27Tis%20Good%20Lord%20to%20Be%20Here%20%E2%80%94%20hymn"}, {"href": "https://www.youtube.com/results?search_query=O%20Wondrous%20Type%21%20O%20Vision%20Fair%20%E2%80%94%20hymn", "t": "♪ O Wondrous Type! O Vision Fair — hymn", "sp": "https://open.spotify.com/search/O%20Wondrous%20Type%21%20O%20Vision%20Fair%20%E2%80%94%20hymn"}, {"href": "https://www.google.com/search?tbm=isch&q=Raphael%2C%20The%20Transfiguration%20%281520%29", "t": "Art · Raphael, The Transfiguration (1520)"}], "s21": [{"href": "https://www.youtube.com/results?search_query=Handel%20Saul%20Dead%20March", "t": "♪ Handel Saul Dead March", "sp": "https://open.spotify.com/search/Handel%20Saul%20Dead%20March"}, {"href": "https://www.google.com/search?tbm=isch&q=Pieter%20Bruegel%2C%20The%20Suicide%20of%20Saul%20%281562%29", "t": "Art · Pieter Bruegel, The Suicide of Saul (1562)"}], "s22": [{"href": "https://www.youtube.com/results?search_query=Mayim%20Mayim%20%E2%80%94%20Israeli%20folk%20dance", "t": "♪ Mayim Mayim — Israeli folk dance", "sp": "https://open.spotify.com/search/Mayim%20Mayim%20%E2%80%94%20Israeli%20folk%20dance"}], "s23": [{"href": "https://www.youtube.com/results?search_query=When%20Jesus%20Wept%20%E2%80%94%20William%20Billings%20round", "t": "♪ When Jesus Wept — William Billings round", "sp": "https://open.spotify.com/search/When%20Jesus%20Wept%20%E2%80%94%20William%20Billings%20round"}, {"href": "https://www.google.com/search?tbm=isch&q=Sebastiano%20del%20Piombo%2C%20The%20Raising%20of%20Lazarus", "t": "Art · Sebastiano del Piombo, The Raising of Lazarus"}, {"href": "https://www.google.com/search?tbm=isch&q=Rembrandt%2C%20The%20Raising%20of%20Lazarus", "t": "Art · Rembrandt, The Raising of Lazarus"}], "s24": [{"href": "https://www.youtube.com/results?search_query=O%20Little%20Town%20of%20Bethlehem", "t": "♪ O Little Town of Bethlehem", "sp": "https://open.spotify.com/search/O%20Little%20Town%20of%20Bethlehem"}, {"href": "https://www.google.com/search?tbm=isch&q=Botticelli%2C%20The%20Mystic%20Nativity", "t": "Art · Botticelli, The Mystic Nativity"}], "s25": [{"href": "https://www.youtube.com/results?search_query=O%20Little%20Town%20of%20Bethlehem", "t": "♪ O Little Town of Bethlehem", "sp": "https://open.spotify.com/search/O%20Little%20Town%20of%20Bethlehem"}, {"href": "https://www.youtube.com/results?search_query=The%20First%20Noel", "t": "♪ The First Noel", "sp": "https://open.spotify.com/search/The%20First%20Noel"}, {"href": "https://www.google.com/search?tbm=isch&q=Gerard%20van%20Honthorst%2C%20Adoration%20of%20the%20Shepherds%20%281622%29", "t": "Art · Gerard van Honthorst, Adoration of the Shepherds (1622)"}, {"href": "https://www.google.com/search?tbm=isch&q=Giotto%2C%20Nativity%20%28Scrovegni%20Chapel%29", "t": "Art · Giotto, Nativity (Scrovegni Chapel)"}], "s26": [{"href": "https://www.youtube.com/results?search_query=Schubert%20Ave%20Maria", "t": "♪ Schubert Ave Maria", "sp": "https://open.spotify.com/search/Schubert%20Ave%20Maria"}, {"href": "https://www.google.com/search?tbm=isch&q=Correggio%2C%20The%20Adoration%20of%20the%20Child", "t": "Art · Correggio, The Adoration of the Child"}], "s27": [{"href": "https://www.youtube.com/results?search_query=Far%20Far%20Away%20on%20Judea%27s%20Plains%20%E2%80%94%20LDS%20hymn", "t": "♪ Far Far Away on Judea's Plains — LDS hymn", "sp": "https://open.spotify.com/search/Far%20Far%20Away%20on%20Judea%27s%20Plains%20%E2%80%94%20LDS%20hymn"}, {"href": "https://www.youtube.com/results?search_query=Angels%20We%20Have%20Heard%20on%20High", "t": "♪ Angels We Have Heard on High", "sp": "https://open.spotify.com/search/Angels%20We%20Have%20Heard%20on%20High"}, {"href": "https://www.google.com/search?tbm=isch&q=Taddeo%20Gaddi%2C%20Annunciation%20to%20the%20Shepherds", "t": "Art · Taddeo Gaddi, Annunciation to the Shepherds"}, {"href": "https://www.google.com/search?tbm=isch&q=Gerard%20van%20Honthorst%2C%20Adoration%20of%20the%20Shepherds%20%281622%29", "t": "Art · Gerard van Honthorst, Adoration of the Shepherds (1622)"}], "s28": [{"href": "https://www.youtube.com/results?search_query=Lecha%20Dodi%20%E2%80%94%20Shabbat%20hymn", "t": "♪ Lecha Dodi — Shabbat hymn", "sp": "https://open.spotify.com/search/Lecha%20Dodi%20%E2%80%94%20Shabbat%20hymn"}, {"href": "https://www.youtube.com/results?search_query=Shalom%20Aleichem%20%E2%80%94%20Shabbat%20song", "t": "♪ Shalom Aleichem — Shabbat song", "sp": "https://open.spotify.com/search/Shalom%20Aleichem%20%E2%80%94%20Shabbat%20song"}, {"href": "https://www.youtube.com/results?search_query=Im%20Eshkachech%20%E2%80%94%20Yaakov%20Shwekey%20%28Psalm%20137%29", "t": "♪ Im Eshkachech — Yaakov Shwekey (Psalm 137)", "sp": "https://open.spotify.com/search/Im%20Eshkachech%20%E2%80%94%20Yaakov%20Shwekey%20%28Psalm%20137%29"}, {"href": "https://www.google.com/search?tbm=isch&q=Gustav%20Bauernfeind%2C%20The%20Wailing%20Wall", "t": "Art · Gustav Bauernfeind, The Wailing Wall"}], "s29": [{"href": "https://www.youtube.com/results?search_query=In%20the%20Garden%20%E2%80%94%20C.%20Austin%20Miles", "t": "♪ In the Garden — C. Austin Miles", "sp": "https://open.spotify.com/search/In%20the%20Garden%20%E2%80%94%20C.%20Austin%20Miles"}, {"href": "https://www.youtube.com/results?search_query=I%20Know%20That%20My%20Redeemer%20Liveth%20%E2%80%94%20Handel%20Messiah", "t": "♪ I Know That My Redeemer Liveth — Handel Messiah", "sp": "https://open.spotify.com/search/I%20Know%20That%20My%20Redeemer%20Liveth%20%E2%80%94%20Handel%20Messiah"}, {"href": "https://www.google.com/search?tbm=isch&q=Eugene%20Burnand%2C%20Peter%20and%20John%20Running%20to%20the%20Sepulchre%20%281898%29", "t": "Art · Eugene Burnand, Peter and John Running to the Sepulchre (1898)"}], "s30": [{"href": "https://www.youtube.com/results?search_query=Erbarme%20dich%20%E2%80%94%20Bach%20St%20Matthew%20Passion", "t": "♪ Erbarme dich — Bach St Matthew Passion", "sp": "https://open.spotify.com/search/Erbarme%20dich%20%E2%80%94%20Bach%20St%20Matthew%20Passion"}, {"href": "https://www.google.com/search?tbm=isch&q=Rembrandt%2C%20The%20Denial%20of%20St.%20Peter%20%281660%29", "t": "Art · Rembrandt, The Denial of St. Peter (1660)"}, {"href": "https://www.google.com/search?tbm=isch&q=Carl%20Bloch%2C%20Peter%27s%20Denial", "t": "Art · Carl Bloch, Peter's Denial"}], "s31": [{"href": "https://www.youtube.com/results?search_query=Ubi%20Caritas%20%E2%80%94%20Durufle", "t": "♪ Ubi Caritas — Durufle", "sp": "https://open.spotify.com/search/Ubi%20Caritas%20%E2%80%94%20Durufle"}, {"href": "https://www.youtube.com/results?search_query=In%20Humility%20Our%20Savior%20%E2%80%94%20LDS%20hymn", "t": "♪ In Humility Our Savior — LDS hymn", "sp": "https://open.spotify.com/search/In%20Humility%20Our%20Savior%20%E2%80%94%20LDS%20hymn"}, {"href": "https://www.google.com/search?tbm=isch&q=Leonardo%20da%20Vinci%2C%20The%20Last%20Supper", "t": "Art · Leonardo da Vinci, The Last Supper"}, {"href": "https://www.google.com/search?tbm=isch&q=Carl%20Bloch%2C%20The%20Last%20Supper", "t": "Art · Carl Bloch, The Last Supper"}], "s32": [{"href": "https://www.youtube.com/results?search_query=Bogoroditse%20Devo%20%E2%80%94%20Rachmaninoff%20All-Night%20Vigil", "t": "♪ Bogoroditse Devo — Rachmaninoff All-Night Vigil", "sp": "https://open.spotify.com/search/Bogoroditse%20Devo%20%E2%80%94%20Rachmaninoff%20All-Night%20Vigil"}, {"href": "https://www.google.com/search?tbm=isch&q=El%20Greco%2C%20Dormition%20of%20the%20Virgin", "t": "Art · El Greco, Dormition of the Virgin"}], "s33": [{"href": "https://www.youtube.com/results?search_query=Christ%20the%20Lord%20Is%20Risen%20Today", "t": "♪ Christ the Lord Is Risen Today", "sp": "https://open.spotify.com/search/Christ%20the%20Lord%20Is%20Risen%20Today"}, {"href": "https://www.youtube.com/results?search_query=I%20Know%20That%20My%20Redeemer%20Liveth%20%E2%80%94%20Handel%20Messiah", "t": "♪ I Know That My Redeemer Liveth — Handel Messiah", "sp": "https://open.spotify.com/search/I%20Know%20That%20My%20Redeemer%20Liveth%20%E2%80%94%20Handel%20Messiah"}, {"href": "https://www.google.com/search?tbm=isch&q=Caravaggio%2C%20The%20Entombment%20of%20Christ%20%281604%29", "t": "Art · Caravaggio, The Entombment of Christ (1604)"}, {"href": "https://www.google.com/search?tbm=isch&q=Rubens%2C%20Descent%20from%20the%20Cross", "t": "Art · Rubens, Descent from the Cross"}], "s34": [{"href": "https://www.youtube.com/results?search_query=The%20Lord%20Is%20My%20Rock%20%E2%80%94%20Psalm%2018%20settings", "t": "♪ The Lord Is My Rock — Psalm 18 settings", "sp": "https://open.spotify.com/search/The%20Lord%20Is%20My%20Rock%20%E2%80%94%20Psalm%2018%20settings"}, {"href": "https://www.google.com/search?tbm=isch&q=David%20Roberts%2C%20Dead%20Sea%20lithographs", "t": "Art · David Roberts, Dead Sea lithographs"}], "s35": [{"href": "https://www.google.com/search?tbm=isch&q=David%20Roberts%2C%20Dead%20Sea%20lithographs", "t": "Art · David Roberts, Dead Sea lithographs"}], "s36": [{"href": "https://www.youtube.com/results?search_query=Down%20to%20the%20River%20to%20Pray", "t": "♪ Down to the River to Pray", "sp": "https://open.spotify.com/search/Down%20to%20the%20River%20to%20Pray"}, {"href": "https://www.youtube.com/results?search_query=Shall%20We%20Gather%20at%20the%20River", "t": "♪ Shall We Gather at the River", "sp": "https://open.spotify.com/search/Shall%20We%20Gather%20at%20the%20River"}, {"href": "https://www.youtube.com/results?search_query=Roll%20Jordan%20Roll%20%E2%80%94%20spiritual", "t": "♪ Roll Jordan Roll — spiritual", "sp": "https://open.spotify.com/search/Roll%20Jordan%20Roll%20%E2%80%94%20spiritual"}, {"href": "https://www.google.com/search?tbm=isch&q=Piero%20della%20Francesca%2C%20The%20Baptism%20of%20Christ", "t": "Art · Piero della Francesca, The Baptism of Christ"}, {"href": "https://www.google.com/search?tbm=isch&q=Verrocchio%20and%20Leonardo%2C%20The%20Baptism%20of%20Christ", "t": "Art · Verrocchio and Leonardo, The Baptism of Christ"}], "s37": [{"href": "https://www.youtube.com/results?search_query=Joshua%20Fit%20the%20Battle%20of%20Jericho%20%E2%80%94%20spiritual", "t": "♪ Joshua Fit the Battle of Jericho — spiritual", "sp": "https://open.spotify.com/search/Joshua%20Fit%20the%20Battle%20of%20Jericho%20%E2%80%94%20spiritual"}, {"href": "https://www.google.com/search?tbm=isch&q=Poussin%2C%20Christ%20Healing%20the%20Blind%20Men%20at%20Jericho%20%28Louvre%29", "t": "Art · Poussin, Christ Healing the Blind Men at Jericho (Louvre)"}], "s38": [{"href": "https://www.youtube.com/results?search_query=Adhan%20%E2%80%94%20call%20to%20prayer%20from%20al-Aqsa", "t": "♪ Adhan — call to prayer from al-Aqsa", "sp": "https://open.spotify.com/search/Adhan%20%E2%80%94%20call%20to%20prayer%20from%20al-Aqsa"}, {"href": "https://www.youtube.com/results?search_query=Tala%27a%20al-Badru%20%27Alayna", "t": "♪ Tala'a al-Badru 'Alayna", "sp": "https://open.spotify.com/search/Tala%27a%20al-Badru%20%27Alayna"}, {"href": "https://www.youtube.com/results?search_query=How%20Lovely%20Is%20Thy%20Dwelling%20Place%20%E2%80%94%20Brahms%20Requiem%20%28Psalm%2084%29", "t": "♪ How Lovely Is Thy Dwelling Place — Brahms Requiem (Psalm 84)", "sp": "https://open.spotify.com/search/How%20Lovely%20Is%20Thy%20Dwelling%20Place%20%E2%80%94%20Brahms%20Requiem%20%28Psalm%2084%29"}, {"href": "https://www.youtube.com/results?search_query=Im%20Eshkachech%20%E2%80%94%20Yaakov%20Shwekey%20%28Psalm%20137%29", "t": "♪ Im Eshkachech — Yaakov Shwekey (Psalm 137)", "sp": "https://open.spotify.com/search/Im%20Eshkachech%20%E2%80%94%20Yaakov%20Shwekey%20%28Psalm%20137%29"}, {"href": "https://www.google.com/search?tbm=isch&q=Dome%20of%20the%20Rock%20mosaics%20and%20Iznik%20tiles", "t": "Art · Dome of the Rock mosaics and Iznik tiles"}, {"href": "https://www.google.com/search?tbm=isch&q=Rembrandt%2C%20Simeon%27s%20Song%20of%20Praise%20%281631%29", "t": "Art · Rembrandt, Simeon's Song of Praise (1631)"}], "s39": [{"href": "https://www.youtube.com/results?search_query=How%20Lovely%20Is%20Thy%20Dwelling%20Place%20%E2%80%94%20Brahms%20Requiem%20%28Psalm%2084%29", "t": "♪ How Lovely Is Thy Dwelling Place — Brahms Requiem (Psalm 84)", "sp": "https://open.spotify.com/search/How%20Lovely%20Is%20Thy%20Dwelling%20Place%20%E2%80%94%20Brahms%20Requiem%20%28Psalm%2084%29"}, {"href": "https://www.google.com/search?tbm=isch&q=Rembrandt%2C%20Simeon%27s%20Song%20of%20Praise%20%281631%29", "t": "Art · Rembrandt, Simeon's Song of Praise (1631)"}], "s41": [{"href": "https://www.youtube.com/results?search_query=Yerushalayim%20Shel%20Zahav%20%28Jerusalem%20of%20Gold%29%20%E2%80%94%20Naomi%20Shemer", "t": "♪ Yerushalayim Shel Zahav (Jerusalem of Gold) — Naomi Shemer", "sp": "https://open.spotify.com/search/Yerushalayim%20Shel%20Zahav%20%28Jerusalem%20of%20Gold%29%20%E2%80%94%20Naomi%20Shemer"}], "s42": [{"href": "https://www.youtube.com/results?search_query=Wade%20in%20the%20Water%20%E2%80%94%20spiritual", "t": "♪ Wade in the Water — spiritual", "sp": "https://open.spotify.com/search/Wade%20in%20the%20Water%20%E2%80%94%20spiritual"}, {"href": "https://www.google.com/search?tbm=isch&q=Murillo%2C%20Christ%20Healing%20the%20Paralytic%20at%20the%20Pool%20of%20Bethesda", "t": "Art · Murillo, Christ Healing the Paralytic at the Pool of Bethesda"}, {"href": "https://www.google.com/search?tbm=isch&q=Hogarth%2C%20The%20Pool%20of%20Bethesda", "t": "Art · Hogarth, The Pool of Bethesda"}], "s43": [{"href": "https://www.youtube.com/results?search_query=Via%20Dolorosa%20%E2%80%94%20Sandi%20Patty", "t": "♪ Via Dolorosa — Sandi Patty", "sp": "https://open.spotify.com/search/Via%20Dolorosa%20%E2%80%94%20Sandi%20Patty"}, {"href": "https://www.youtube.com/results?search_query=Stabat%20Mater%20%E2%80%94%20Pergolesi", "t": "♪ Stabat Mater — Pergolesi", "sp": "https://open.spotify.com/search/Stabat%20Mater%20%E2%80%94%20Pergolesi"}, {"href": "https://www.google.com/search?tbm=isch&q=El%20Greco%2C%20Christ%20Carrying%20the%20Cross", "t": "Art · El Greco, Christ Carrying the Cross"}, {"href": "https://www.google.com/search?tbm=isch&q=Hieronymus%20Bosch%2C%20Christ%20Carrying%20the%20Cross%20%28Ghent%29", "t": "Art · Hieronymus Bosch, Christ Carrying the Cross (Ghent)"}], "s44": [{"href": "https://www.youtube.com/results?search_query=Only%20a%20Boy%20Named%20David%20%E2%80%94%20Primary%20song", "t": "♪ Only a Boy Named David — Primary song", "sp": "https://open.spotify.com/search/Only%20a%20Boy%20Named%20David%20%E2%80%94%20Primary%20song"}, {"href": "https://www.google.com/search?tbm=isch&q=Caravaggio%2C%20David%20with%20the%20Head%20of%20Goliath", "t": "Art · Caravaggio, David with the Head of Goliath"}, {"href": "https://www.google.com/search?tbm=isch&q=Osmar%20Schindler%2C%20David%20und%20Goliath", "t": "Art · Osmar Schindler, David und Goliath"}], "s46": [{"href": "https://www.google.com/search?tbm=isch&q=Lachish%20Reliefs%20%E2%80%94%20British%20Museum", "t": "Art · Lachish Reliefs — British Museum"}], "s47": [{"href": "https://www.youtube.com/results?search_query=All%20Glory%20Laud%20and%20Honor%20%E2%80%94%20Palm%20Sunday%20hymn", "t": "♪ All Glory Laud and Honor — Palm Sunday hymn", "sp": "https://open.spotify.com/search/All%20Glory%20Laud%20and%20Honor%20%E2%80%94%20Palm%20Sunday%20hymn"}, {"href": "https://www.youtube.com/results?search_query=Ride%20On%20Ride%20On%20in%20Majesty", "t": "♪ Ride On Ride On in Majesty", "sp": "https://open.spotify.com/search/Ride%20On%20Ride%20On%20in%20Majesty"}, {"href": "https://www.google.com/search?tbm=isch&q=Giotto%2C%20Entry%20into%20Jerusalem%20%28Scrovegni%20Chapel%29", "t": "Art · Giotto, Entry into Jerusalem (Scrovegni Chapel)"}], "s48": [{"href": "https://www.youtube.com/results?search_query=Jerusalem%20Thou%20That%20Killest%20the%20Prophets%20%E2%80%94%20Mendelssohn%20St%20Paul", "t": "♪ Jerusalem Thou That Killest the Prophets — Mendelssohn St Paul", "sp": "https://open.spotify.com/search/Jerusalem%20Thou%20That%20Killest%20the%20Prophets%20%E2%80%94%20Mendelssohn%20St%20Paul"}, {"href": "https://www.google.com/search?tbm=isch&q=Enrique%20Simonet%2C%20Flevit%20super%20illam%20%281892%29", "t": "Art · Enrique Simonet, Flevit super illam (1892)"}], "s49": [{"href": "https://www.youtube.com/results?search_query=Reverently%20and%20Meekly%20Now%20%E2%80%94%20LDS%20hymn", "t": "♪ Reverently and Meekly Now — LDS hymn", "sp": "https://open.spotify.com/search/Reverently%20and%20Meekly%20Now%20%E2%80%94%20LDS%20hymn"}, {"href": "https://www.youtube.com/results?search_query=Gethsemane%20%E2%80%94%20Melanie%20Hoffman", "t": "♪ Gethsemane — Melanie Hoffman", "sp": "https://open.spotify.com/search/Gethsemane%20%E2%80%94%20Melanie%20Hoffman"}, {"href": "https://www.youtube.com/results?search_query=Go%20to%20Dark%20Gethsemane", "t": "♪ Go to Dark Gethsemane", "sp": "https://open.spotify.com/search/Go%20to%20Dark%20Gethsemane"}, {"href": "https://www.google.com/search?tbm=isch&q=Carl%20Bloch%2C%20Christ%20in%20Gethsemane%20%281879%29", "t": "Art · Carl Bloch, Christ in Gethsemane (1879)"}, {"href": "https://www.google.com/search?tbm=isch&q=Heinrich%20Hofmann%2C%20Christ%20in%20Gethsemane", "t": "Art · Heinrich Hofmann, Christ in Gethsemane"}], "s50": [{"href": "https://www.youtube.com/results?search_query=Go%20to%20Dark%20Gethsemane", "t": "♪ Go to Dark Gethsemane", "sp": "https://open.spotify.com/search/Go%20to%20Dark%20Gethsemane"}, {"href": "https://www.google.com/search?tbm=isch&q=Carl%20Bloch%2C%20Christ%20in%20Gethsemane%20%281879%29", "t": "Art · Carl Bloch, Christ in Gethsemane (1879)"}], "s51": [{"href": "https://www.youtube.com/results?search_query=God%20Be%20with%20You%20Till%20We%20Meet%20Again", "t": "♪ God Be with You Till We Meet Again", "sp": "https://open.spotify.com/search/God%20Be%20with%20You%20Till%20We%20Meet%20Again"}], "s52": [{"href": "https://www.youtube.com/results?search_query=Eli%20Eli%20%28Halikha%20LeKesariya%29%20%E2%80%94%20Hannah%20Szenes", "t": "♪ Eli Eli (Halikha LeKesariya) — Hannah Szenes", "sp": "https://open.spotify.com/search/Eli%20Eli%20%28Halikha%20LeKesariya%29%20%E2%80%94%20Hannah%20Szenes"}, {"href": "https://www.google.com/search?tbm=isch&q=David%20Roberts%2C%20Caesarea%20lithograph", "t": "Art · David Roberts, Caesarea lithograph"}], "s53": [{"href": "https://www.youtube.com/results?search_query=Hine%20Ma%20Tov%20%28Psalm%20133%20%E2%80%94%20the%20dew%20of%20Hermon%29", "t": "♪ Hine Ma Tov (Psalm 133 — the dew of Hermon)", "sp": "https://open.spotify.com/search/Hine%20Ma%20Tov%20%28Psalm%20133%20%E2%80%94%20the%20dew%20of%20Hermon%29"}, {"href": "https://www.youtube.com/results?search_query=Sicut%20Cervus%20%E2%80%94%20Palestrina%20%28Psalm%2042%29", "t": "♪ Sicut Cervus — Palestrina (Psalm 42)", "sp": "https://open.spotify.com/search/Sicut%20Cervus%20%E2%80%94%20Palestrina%20%28Psalm%2042%29"}], "s54": [{"href": "https://www.youtube.com/results?search_query=God%20Be%20with%20You%20Till%20We%20Meet%20Again", "t": "♪ God Be with You Till We Meet Again", "sp": "https://open.spotify.com/search/God%20Be%20with%20You%20Till%20We%20Meet%20Again"}, {"href": "https://www.youtube.com/results?search_query=The%20Lord%20Bless%20You%20and%20Keep%20You%20%E2%80%94%20Rutter", "t": "♪ The Lord Bless You and Keep You — Rutter", "sp": "https://open.spotify.com/search/The%20Lord%20Bless%20You%20and%20Keep%20You%20%E2%80%94%20Rutter"}]};
...
// One-time Aug-2026 itinerary revision: drop Sepphoris/Mount Arbel (unless journaled) and match official day order
function applyItineraryRevisions(s){
  if(!s||!Array.isArray(s.itinerary)) return s;
  const drop=["s10","s11"];
  const hasJournal=(sid)=>{const j=(s.journal||{})[sid];return !!(j&&((j.text&&j.text.trim())||(j.photos&&j.photos.length)));};
  const order={}; BACKBONE.forEach((d)=>{order[d.date]=d.sids;});
  s.itinerary.forEach((day)=>{
    day.sids=(day.sids||[]).filter((sid)=>!(drop.includes(sid)&&!hasJournal(sid)));
    const ord=order[day.date];
    if(ord){const inb=day.sids.filter((x)=>ord.includes(x)).sort((a,b)=>ord.indexOf(a)-ord.indexOf(b));const rest=day.sids.filter((x)=>!ord.includes(x));day.sids=[...inb,...rest];}
  });
  return s;
}
...
export default function App(){
  ...
  async function openTrip(id){
    ...
    if(id===JER_ID) s=applyItineraryRevisions(s);
...
function PrepPage({back}){
  return (
    <div>
      ...
      <PrepSection title="August 2026 Itinerary (As Written)" defaultOpen>
        <p style={{fontSize:12.5,color:C.inkSoft,marginBottom:8}}>The official itinerary, exactly as distributed. It is dynamic and may be updated as plans change.</p>
        <pre style={{whiteSpace:"pre-wrap",fontFamily:"inherit",fontSize:13.5,lineHeight:1.55,color:C.ink,margin:0}}>{ITIN_DOC}</pre>
      </PrepSection>
    ...
    <div>
      ...
      {info&&(
        <div>
          ...
          <div className="mb-3" style={{fontSize:11,color:C.inkSoft,lineHeight:1.4}}>{info.faiths.map((f)=>FAITHS[f]&&FAITHS[f].label).filter(Boolean).join(" · ")}{info.talmage?" · Talmage excerpt":""}</div>
        </div>
      )}
      ...
      {info&&(
        <div className="mt-8">
          ...
          {ARTMUSIC[sid]?.length>0&&<StudyLinks title="Art & Music" items={ARTMUSIC[sid]} icon={Music}/>}
          {CHOSEN[sid]?.length>0&&<StudyLinks title="The Chosen · free on BYUtv" items={CHOSEN[sid]} icon={ExternalLink}/>}
        </div>
      )}
  ...
  return (
    <div className="mb-3 p-3.5 rounded-2xl" style={{background:C.card,border:`1px solid ${C.line}`}}>
      ...
      <ul className="flex flex-col gap-1.5">
        {items.map((it,i)=>(<li key={i}><a href={it.href} target="_blank" rel="noopener noreferrer" className="flex items-start gap-1.5" style={{fontSize:14,color:C.teal,lineHeight:1.4}}><ExternalLink size={12} className="mt-1 shrink-0" style={{opacity:0.7}}/> {it.t}</a>{it.sp&&<a href={it.sp} target="_blank" rel="noopener noreferrer" style={{fontSize:12.5,color:C.brassDk,marginLeft:19,display:"inline-block",marginTop:2}}>{it.spl||"Listen on Spotify ↗"}</a>}{it.why&&<div style={{fontSize:12.5,color:C.inkSoft,lineHeight:1.5,margin:"2px 0 4px 19px",fontStyle:"italic"}}>{it.why}</div>}</li>))}
      </ul>
    </div>
  );
}
